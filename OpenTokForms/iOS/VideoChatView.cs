...
namespace OpenTokForms.iOS
{
    ...
    public partial class VideoChatView : UIView
    {
        ...
        public VideoChatView()
        {
            ...
            view.Frame = new RectangleF(0, 0, (float)Frame.Width, (float)Frame.Height);
        ...
        private void DoPublish()
        {
            ...
            _publisher = new OTPublisher(new PublisherDelegate(this), Settings);
        ...
        private class SubscriberDelegate : OTSubscriberKitDelegate
        {
            ...
            public override void DidConnectToStream(OTSubscriber subscriber)
            {
                ...
                //CGRect asd = UIScreen.MainScreen.Bounds;
